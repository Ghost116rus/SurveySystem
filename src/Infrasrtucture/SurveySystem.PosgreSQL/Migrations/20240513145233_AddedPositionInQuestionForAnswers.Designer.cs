...
namespace SurveySystem.PosgreSQL.Migrations
{
    ...
    [Migration("20240513145233_AddedPositionInQuestionForAnswers")]
    partial class AddedPositionInQuestionForAnswers
    {
            ...
            modelBuilder.Entity("SurveySystem.Domain.Entities.Surveys.Answer", b =>
                {
                    ...
                    b.Property<int>("PositionInQuestion")
                        .HasColumnType("integer")
                        .HasColumnName("position_in_question")
            ...
            modelBuilder.Entity("SurveySystem.Domain.Entities.Surveys.Question", b =>
                {
                    ...
                    b.Property<bool>("IsAutoCreatedAnswers")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("is_auto_created_answers")
